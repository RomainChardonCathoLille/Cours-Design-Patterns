public class User {
    ...
    public void appliquer_effet(Effet effet){
        ...
        if(this.clerge < 0) this.clerge = 0;

        if(this.finance > max_value) this.finance = max_value;
        if(this.armee > max_value) this.armee = max_value;
        if(this.peuple > max_value) this.peuple = max_value;
        if(this.clerge > max_value) this.clerge = max_value;
